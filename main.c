...
int main(void) {
    ...
    Vector vel = {0.5, -0.3, 0.8};
    Vector acc = {0.1, 0.2, -0.1};
    
    Entity test_entity = new_entity("Test Object", 10.0, 5.0, &pos, &vel, &acc, 0.7, true, false);
    
    test_entity.quaternion[0] = 0.7071;
    test_entity.quaternion[1] = 0.0;
    test_entity.quaternion[2] = 0.7071;
    test_entity.quaternion[3] = 0.0;
    ...
    Vector static_pos = {0.0, 0.0, 0.0};
    Vector static_vel = {0.0, 0.0, 0.0};
    Vector static_acc = {0.0, 0.0, 0.0};
